...
//  Returns:  See Purpose.
size_t sqtpFrameGetLength( const uint8_t *buf );
...
SqtpStatus_t sqtpFrameReaderInit( SqtpFrameReader_t *fr, const uint8_t *buf,
  size_t sz );
...
//  Returns:  Object at fr modified; returned value is same as fr->status.
SqtpStatus_t sqtpFrameReaderReset( SqtpFrameReader_t *fr );
...
//  Returns:  Object at fr modified; returned value is same as fr->status.
SqtpStatus_t sqtpFrameReaderNext( SqtpFrameReader_t *fr );
...
SqtpStatus_t sqtpFrameWriterInit( SqtpFrameWriter_t *fw,
...
//  Returns:  Object at fr modified; returned value is same as fr->status.
SqtpStatus_t sqtpFrameWriterReset( SqtpFrameWriter_t * fw );
...
//  Returns:  Object at fr modified; returned value is same as fr->status.
SqtpStatus_t sqtpFrameWriterWriteDirect( SqtpFrameWriter_t *fw,
...
//  Returns:  Object at fr modified; returned value is same as fr->status.
SqtpStatus_t sqtpFrameWriterWriteSubframe( SqtpFrameWriter_t *fw,
...
SqtpStatus_t sqtpFrameWriterFinalize( SqtpFrameWriter_t *fw );
...
SqtpFrameReader_t sqtpFrameReaderInitStruct( const uint8_t *buf, size_t sz );
SqtpFrameReader_t sqtpFrameReaderResetStruct( SqtpFrameReader_t fr );
SqtpFrameReader_t sqtpFrameReaderNextStruct( SqtpFrameReader_t fr );
SqtpFrameWriter_t sqtpFrameWriterInitStruct( uint8_t *buf, size_t sz );
SqtpFrameWriter_t sqtpFrameWriterResetStruct( SqtpFrameWriter_t fw );
SqtpFrameWriter_t sqtpFrameWriterWriteStructDirect( SqtpFrameWriter_t fw,
  SqtpSubframeId_t id, const uint8_t *payload, size_t sz );
SqtpFrameWriter_t sqtpFrameWriterWriteStructSubframe( SqtpFrameWriter_t fw,
  SqtpSubframe_t sf );
SqtpFrameWriter_t sqtpFrameWriterFinalizeStruct( SqtpFrameWriter_t fw );
